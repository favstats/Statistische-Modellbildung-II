...
Die **Odds** (Chancen) sind einfach die eulersche Zahl hoch die logits (wird mit `exp()` berechnet)
...
Laut Model 1 beträgt die Wahrscheinlichkeit für eine 30 - Jährige Frau mit höchstem Bildungsabschluss über 2500 Euro im Monat zu verdienen bei 8.06%.
...
Denken daran, dass $e^1 ≈ 2.71$. Das heißt, wenn der Logit 1 ist, liegen die Chancen bei 2,7 zu 1, so ist die Wahrscheinlichkeit \frac{2.7}{3.7}, also ca. 0.73 oder 73%.

Ähnlich wichtig ist $e^0 = 1$. Daher liegen die Chancen 1 : 1, d.h. bei 50%.
